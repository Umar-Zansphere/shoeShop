                    ...
                    {step === 2 && (
                        <form onSubmit={handleVerifyOTP} className="space-y-6">
                            ...
                            <button
                                type="button"
                                onClick={() => setStep(1)}
                                className="w-full px-6 py-3 min-h-11 text-gray-600 hover:text-gray-900 font-medium transition-colors touch-manipulation active:scale-95"
                            >
                                ← Change Phone Number
                            </button>
                        </form>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-3 pt-4">
                                <button
                                    ...
                                    className="flex-1 px-6 py-3 min-h-11 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 font-medium transition-colors touch-manipulation active:scale-95"
                                >
                                    Track Another Order
                                </button>
                                <button
                                    onClick={() => router.push('/products')}
                                    className="flex-1 px-6 py-3 min-h-11 bg-orange-600 text-white rounded-xl hover:bg-orange-700 font-medium transition-colors touch-manipulation active:scale-95"
                                >
                                    Continue Shopping
                                </button>
                            </div>
