    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 py-8 w-full">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 p-8 sm:p-12 text-center mb-8 shadow-sm">
          ...
          {/* Order Number */}
          <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-6 mb-8">
          ...
          <div className="border-t-2 border-slate-200 pt-8">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-left">
              ...
              <div className="bg-indigo-50 border border-indigo-200 rounded-2xl p-4">
                <div className="flex gap-3">
                  <Truck size={24} className="text-indigo-600 flex-shrink-0" />
                  <div>
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-2xl p-4">
                <div className="flex gap-3">
                  <Package size={24} className="text-purple-600 flex-shrink-0" />
                  <div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-2xl p-4">
                <div className="flex gap-3">
                  <Home size={24} className="text-green-600 flex-shrink-0" />
                  <div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <button
            ...
            className="px-6 py-4 min-h-[44px] border-2 border-orange-600 text-orange-600 rounded-2xl hover:bg-orange-50 transition-colors font-bold touch-manipulation active:scale-95"
          >
            Continue Shopping
          </button>
          <button
            onClick={() => router.push('/orders')}
            className="px-6 py-4 min-h-[44px] bg-orange-600 text-white rounded-2xl hover:bg-orange-700 transition-colors font-bold shadow-md hover:shadow-lg touch-manipulation active:scale-95"
          >
            View All Orders
          </button>
        </div>
